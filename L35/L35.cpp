...
void resuelveCaso() {
    ...
    std::vector<pt> poligono = convexHull(points);
    T areaPol = areaPolygon(poligono);

    
    std::cout << std::fixed << std::setprecision(1) <<(areaTables / areaPol) * 100 << " %\n";
}
